...
//> inherit-self
    if (stmt.superclass != null &&
      ...
      Pseuci.error(stmt.superclass.name,
...
//> return-from-top
    if (currentFunction == FunctionType.NONE) {
      Pseuci.error(stmt.keyword, "Cannot return from top-level code.");
    }
