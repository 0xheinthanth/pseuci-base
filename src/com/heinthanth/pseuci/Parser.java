...
import static com.heinthanth.pseuci.TokenType.*;
...
class Parser {
  ...
  /*
   * Parsing Expressions parse < Statements and State parse Expr parse() { try {
   * return expression(); } catch (ParseError error) { return null; } }
   */
  ...
  private Expr expression() {
    /*
     * Parsing Expressions expression < Statements and State expression return
     * equality();
     */
  ...
  private Stmt classDeclaration() {
    ...
    // < Inheritance parse-superclass
    consume(DO, "Expect 'do' before class body.");

    List<Stmt.Function> methods = new ArrayList<>();
    while (!check(DONE) && !isAtEnd()) {
      methods.add(function("method"));
    }

    consume(DONE, "Expect 'done' after class body.");

    /*
     * Classes parse-class-declaration < Inheritance construct-class-ast return new
  ...
  private Stmt forStatement() {
    ...
    /*
     * Control Flow for-statement < Control Flow for-initializer // More here...
     */
    // > for-initializer
    Stmt initializer;
    if (match(SEMICOLON)) {
  ...
  private Expr assignment() {
    /*
     * Statements and State parse-assignment < Control Flow or-in-assignment Expr
     * expr = equality();
     */
  ...
  private Expr unary() {
    ...
    /*
     * Parsing Expressions unary < Functions unary-call return primary();
     */
