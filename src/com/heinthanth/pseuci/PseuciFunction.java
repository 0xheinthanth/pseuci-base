...
class PseuciFunction implements PseuciCallable {
   ...
   * PseuciFunction(Stmt.Function declaration) {
   */
  /*
   * Functions closure-constructor < Classes is-initializer-field
   * PseuciFunction(Stmt.Function declaration, Environment closure) {
   */
...
//< closure-constructor
  ...
  PseuciFunction bind(PseuciInstance instance) {
    ...
    return new PseuciFunction(declaration, environment, isInitializer);
    // < lox-function-bind-with-initializer
  }
  ...
  public Object call(Interpreter interpreter, List<Object> arguments) {
    /*
     * Functions function-call < Functions call-closure Environment environment =
